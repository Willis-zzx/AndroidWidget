package com.example.tcpclientandroid.funcs;
...
import com.example.tcpclientandroid.R;
import com.example.tcpclientandroid.coms.TcpServer;
...
public class FuncTcpServer extends AppCompatActivity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.btn_tcpServerConn:
                    ...
                    tcpServer = new TcpServer(Integer.parseInt(editServerPort.getText().toString().trim()));
                ...
                case R.id.btn_tcpServerSend:
                    ...
                    exec.execute(new Runnable() {
                        @Override
                        public void run() {
                            if (tcpServer.SST != null && tcpServer.SST.size() != 0) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_func_tcp_server);
        context = this;
        bindID();
        bindListener();
        bindReceiver();
